#Written by: John Reed, Peter Lin, Matt Araneta
#Tested by: John Reed
#debugged by: John Reed, Kevin Hsieh
...
sub getWeather{
	...
	my $url = "http://api.wunderground.com/api/e9da4630d7f62815/conditions/q/$zipcode.json"; #sets up url, this needs to be dynamic
